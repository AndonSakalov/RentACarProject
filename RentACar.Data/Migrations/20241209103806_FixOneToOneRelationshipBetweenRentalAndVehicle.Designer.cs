...
namespace RentACar.Data.Migrations
{
    ...
    [Migration("20241209103806_FixOneToOneRelationshipBetweenRentalAndVehicle")]
    partial class FixOneToOneRelationshipBetweenRentalAndVehicle
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RentACar.Data.Models.Reservation", b =>
                {
                    ...
                    b.Property<DateTime>("PickUpDate")
                        .HasColumnType("datetime2")
                        .HasComment("The pick up date for the reserved vehicle.");

                    b.Property<decimal>("Price")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)")
                        .HasComment("The price for the reserved rental.");

                    b.Property<DateTime>("ReturnDate")
                        .HasColumnType("datetime2")
                        .HasComment("The return date for the reserved vehicle.");
            ...
            modelBuilder.Entity("RentACar.Data.Models.Vehicle", b =>
                {
                    ...
                    b.HasOne("RentACar.Data.Models.Rental", "Rental")
                        .WithOne("Vehicle")
                        .HasForeignKey("RentACar.Data.Models.Vehicle", "RentalId")
