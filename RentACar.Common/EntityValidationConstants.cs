namespace RentACar.Common
{
    public class EntityValidationConstants
    {
        public static class Vehicle
        {
            ...
            public const int YearMinRange = 1886;
            public const int YearMaxRange = 9999;
        ...
        public static class Engine
        {
            ...
            public const int FuelEfficiencyMinForElectric = 0;
            public const int FuelEfficiencyMaxForElectric = 50;

            public const int DisplacementMinRangeForElectric = 0;
            public const double DisplacementMaxRangeForElectric = 10;

            public const int CylindersMinCountForElectric = 0;
            public const int CylindersMaxCountForElectric = 16;
        }
